...
\noindent\begin{tabularx}{\linewidth}{@{}lR@{}}
	...
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
			\item Led development of Geant4 detector simulation to conduct case
				studies of neutron capture doping agents in solid scintillator.
				Simulation results were later used to guide overall detector
	...
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
			\item Used CAD to design from scratch and assemble apparatus to
				measure light output of various LAB based scintillators from
				ionizing radiation as well as test light yield changes in
				extreme electric potential gradients ($\SI{\sim
				1}{\kilo\volt\per\centi\meter}$)
			%\item Led critical role in directional neutrino/neutron
			%	reconstruction algorithm
			\item Operated machine, took data, and analyzed light
				transmissivity of LAB based scintillator when put in near
				freezing temperatures and high pressure environments (for
				potential deep sea deployment scenarios) in custom made
				pressurizer chamber
			%\item Spearheaded trade studies for \ce{Li}/\ce{B} neutron capture
			%	dopants in scintillator
		\end{itemize}
	...
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
			\item Spearheading development of precision $\alpha$ background
				...
				inverted neutrino mass hierarchy of $0\nu\beta\beta$ decay in
				\ce{^{130}Te}
...
decay in \ce{^{130}Te}. CUORE employs an almost 20 fold increase in detector

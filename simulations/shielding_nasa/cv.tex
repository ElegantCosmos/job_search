...
%\begin{center}
	...
	\noindent\begin{tabular}{r @{$\quad\bullet\quad$} l}
		\href{mailto:michsakai@berkeley.edu}{michsakai@berkeley.edu} & 808-206-4357
	\end{tabular}
%\end{center}
...
\noindent\begin{tabularx}{\linewidth}{@{}lR@{}}
	...
	\textsc{UC Berkeley --- }Post-doctoral Scholar & \textsc{June 2018 ---} \textit{Current}\\
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		...
		\begin{itemize}
			\item Building apparatus for measuring micro-physical optical
				properties of tetraphenyl butadiene (TPB)
			\item Responsible for Geant4 simulation of optical modeling of
				apparatus and TPB material
		\end{itemize} 
	\end{minipage}}\\

	\addlinespace[5pt]
	%\textbf{CUORE (Cryogenic Underground Observatory for Rare Events)} & \textsc{Mar. 15, 2016 -} \textit{Current}\\
	\textsc{UCLA --- }Post-doctoral Scholar & \textsc{2016 ---} \textsc{2018}\\
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		%\textit{Post-doctoral Scholar, University of California, Los Angeles (UCLA)}
		%\textit{University of California, Los Angeles (UCLA)}
		\begin{itemize}
...
\noindent\begin{tabularx}{\linewidth}{@{}lR@{}}
	...
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
			\item Advising undergraduate student with \textsc{Geant4} based
				optical simulation for current hardware project
		\end{itemize}
	\end{minipage}}\\

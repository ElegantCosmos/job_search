...
\begin{center}
	...
	\noindent\begin{tabular}{r @{$\quad\bullet\quad$} c @{$\quad\bullet\quad$} l}
		\href{mailto:michsakai@berkeley.edu}{michsakai@berkeley.edu} & 808.206.4357 & \href{https://www.linkedin.com/in/michinari-sakai-956b3b156/}{www.linkedin.com/in/michinari-sakai-956b3b156}
	\end{tabular}
\end{center}
...
\noindent\begin{tabularx}{\linewidth}{@{{}\textbullet\enskip}X@{\quad}r@{}}
	Experience with nuclear decay and cosmogenic radiation in 3 multinational
	particle/nuclear physics experiments. & \\
	Strong attention to detail in current work as well as ability to learn new
	skills.& \\
...
\noindent\begin{tabularx}{\linewidth}{@{}lR@{}}
	...
	\textcolor{NavyBlue}{\textsc{UC Berkeley --- }Post-doctoral Researcher} & \textcolor{NavyBlue}{\textsc{June 2018 ---} \textit{Current}}\\
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		%\textit{Post-doctoral Researcher, University of California, Los Angeles (UCLA)}
		%\textit{University of California, Los Angeles (UCLA)}
		\begin{itemize}
			\item Modeling and calibration of
				\ce{^{238}U}/\ce{^{232}Th} decay radiation induced energy
				depositions in detector materials.
			\item Supervisor for \textsc{Geant4} modeling of photon
				interactions with optical wavelength shifters and detector
				materials.
			\item Lead researcher for characterization of micro-physical
				optical properties of optical wavelength shifter thin
				films.
		\end{itemize} 
	\end{minipage}}\\

	%\textbf{CUORE (Cryogenic Underground Observatory for Rare Events)} & \textsc{Mar. 15, 2016 -} \textit{Current}\\
	\textcolor{NavyBlue}{\textsc{UCLA --- }Post-doctoral Researcher} & \textcolor{NavyBlue}{\textsc{2016 ---} \textsc{2018}}\\
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		%\textit{Post-doctoral Researcher, University of California, Los Angeles (UCLA)}
		%\textit{University of California, Los Angeles (UCLA)}
		\begin{itemize}
			\item Lead developer of precision $\alpha$ decay spectrum model to
				improve characterization of $\alpha$/$\beta$/$\gamma$
				backgrounds in $0\nu\beta\beta$ decay searches.
			\item Mentor for 2 PhD students to simulate radiation shielding
				structures in \textsc{Geant4} to mitigate $\gamma$/$\beta$
				backgrounds for next generation $0\nu\beta\beta$ searches
				requiring ultra-low radiation backgrounds.
	...
	\textcolor{NavyBlue}{\textsc{University of Hawaii at Manoa --- }Research Assistant} & \textcolor{NavyBlue}{\textsc{2009 --- 2016}}\\
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		...
		\begin{itemize}
			\item Spearheaded development of a novel directional neutrino
				...
				preparation.
			\item Lead developer of \textsc{Geant4} detector simulation to
...
\noindent\begin{tabularx}{\linewidth}{@{}rl}
	Software/Tools: & \textsc{ROOT}/RooFit, \textsc{Geant4}, \textsc{SolidWorks}, \textsc{AutoCAD}, \textsc{COMSOL}\\
	Programming Languages: & Python, C/C++, Mathematica, Fortran, SolidWorks, AutoCAD, BASH.\\
...
\noindent\begin{tabularx}{\linewidth}{@{}lR@{}}
	...
	\textcolor{NavyBlue}{\textsc{Mentor} --- \textit{UC Berkeley}, \textit{UCLA}} & \textcolor{NavyBlue}{\textsc{March 2016 ---} \textit{Current}}\\
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
			\item Advised 2 students with \textsc{Geant4} based optical
			...
			\item Taught weekly \textsc{Geant4} tutorials to \num{3} PhD-level
				...
				on independent radiation modeling projects.
	...
	%%\textsc{Mentor}, \textit{UCLA} & \textsc{Mar 2016 -} \textit{Current}\\
	%\textsc{Mentor} --- \textit{UC Berkeley} & \textsc{June 2018 --- } \textit{Current}\\
	%\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
	%	\begin{itemize}
	%		\item Advised 2 students with \textsc{Geant4} based
	...
	%%\textsc{Mentor}, \textit{UCLA} & \textsc{Mar 2016 -} \textit{Current}\\
	%\textsc{Mentor} --- \textit{UCLA} & \textsc{2016}\\
	%\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
	%	\begin{itemize}
	%		\item Taught weekly \textsc{Geant4} tutorials to \num{3} PhD-level
	%			students for a semester. Students successfully learned to take
	...
	\textcolor{NavyBlue}{\textsc{Teaching Assistant} --- \textit{University of Hawaii at Manoa}} & \textcolor{NavyBlue}{\textsc{2007 --- 2009}}\\
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
...
%\noindent\begin{tabular}{rp{10.3cm}}	
	...
	\textcolor{NavyBlue}{\textsc{PhD, Experimental Particle Physics}} & \textcolor{NavyBlue}{\textsc{2016}}\\
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
...
%------------------------------------------------
	...
	\textcolor{NavyBlue}{\textsc{Double BS, Physics and Mathematics}} & \textcolor{NavyBlue}{\textsc{2005}}\\
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
...
\clearpage
\section{Oral Presentations and Posters}
...
I have a strong background in nuclear decay radiation/particle transport
modeling and how they affect real hardware in particle detectors. My expertise
also involves processing and analyzing large-scale physics data using analysis
tools such as ROOT/RooFit and Python. I have experience working in 3
multinational collaboration physics experiments where I spearheaded independent
research initiatives and successfully interfaced my original work with the
larger team. Some of my past accomplishments that I take pride in include
development of unprecedented particle detection algorithms that I project will
open whole new physics searches by the collaborations that I have worked with.
...
\ce{^{238}U}/\ce{^{232}Th} decay radiation induced energy depositions in
detector materials. The energy spectrum of the background isotopes that produce
$\alpha$ daughters ($\gtrsim \SI{2.7}{\mega\electronvolt}$) exhibit peculiar
features that, if understood correctly, will better explain the types of
radioactive contamination sources and their distributions in the materials
comprising the experiment. This can help us to better understand our background
sources and extrapolate this understanding to the energy region of interest
...
neutron/neutrino detector. In this project, I mentored 3 students and worked in
...
In summary my strong background in nuclear decay radiation/particle transport
modeling and how they affect real hardware, as well as, my extensive experience
in using various tools to statistically analyze large-scale physics data makes

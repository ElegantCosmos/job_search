...
\recipient{Space Science and Applications Group (ISR-1)}
...
As a budding and motivated physicist, I am extremely interested in joining the
Space Science and Applications Group to contribute toward ongoing and future
applied and basic science missions. 
...
\noindent\begin{tabularx}{\linewidth}{@{{}\textbullet\enskip}X@{\quad}@{}}
	...
	on particle transport simulations, algorithm software development, and
	large-scale data analysis for novel particle detection technologies.\\
	...
	photon propagation.\\
	\textbf{Demonstrated record of recent publications and presentations:}
	...
	\textbf{Ability to work independently and as a member of a team, with good
	communication skills:} Worked in 3 multinational collaborations comprised
	...
	\textbf{Ability to obtain a DOE ``Q'' clearance:} US citizen.\\

...
\noindent\begin{tabularx}{\linewidth}{@{{}\textbullet\enskip}X@{\quad}r@{}}
	Expertise in particle transport simulation code (C++) with 8 years of
	experience. & \\
	Experience in large-scale data analysis and algorithm software development.
	& \\
...
\noindent\begin{tabularx}{\linewidth}{@{}lR@{}}
	...
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		...
		\begin{itemize}
			...
			\item Supervisor for C++ software simulation/modeling of photon
				interactions with wavelength shifters.
	...
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		...
		\begin{itemize}
			...
			\item Mentor for 2 PhD students to simulate radiation shielding
				structures in C++ to mitigate $\gamma$/$\beta$ backgrounds for
				next generation $0\nu\beta\beta$ searches requiring ultra-low
	...
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		...
		\begin{itemize}
			...
			\item Lead developer of detector simulation code (C++)
...
\noindent\begin{tabularx}{\linewidth}{@{}rl}
	Software/Tools: & \textsc{Geant4}, \textsc{ROOT}, \textsc{SolidWorks}, \textsc{AutoCAD}, \textsc{ComSol}, \textsc{Pads}, Git\\
	Programming Languages: & Proficient in C, C++, Python, Mathematica, Fortran, BASH, Matlab\\

...
\begin{center}
	\noindent{\textcolor{NavyBlue}{\huge{Michinari Sakai}}}\\% Your name
...
\section{\textcolor{NavyBlue}{Summary}}
...
\noindent\begin{tabularx}{\linewidth}{@{}lR@{}}
	...
	\textbf{Post-doctoral Researcher, \textit{UC Berkeley}} & \textbf{June 2018 --- \textit{Present}}\\
	...
	%\textbf{CUORE (Cryogenic Underground Observatory for Rare Events)} & \textsc{Mar. 15, 2016 -} \textit{Current}\\
	\textbf{Post-doctoral Researcher, \textit{UCLA}} & \textbf{2016 --- 2018}\\
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		%\textit{Post-doctoral Scholar, University of California, Los Angeles (UCLA)}
		%\textit{University of California, Los Angeles (UCLA)}
		\begin{itemize}
	...
	\textbf{Research Assistant, \textit{University of Hawaii at Manoa}} & \textbf{2009 --- 2016}\\
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
...
\noindent\begin{tabularx}{\linewidth}{@{}lR@{}}
	...
	\textbf{Mentor, \textit{UC Berkeley}, \textit{UCLA}} & \textbf{March 2016 --- \textit{Present}}\\
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
			...
			\item Taught weekly \textsc{Geant4} physics simulation tutorials to
	...
	\textbf{Teaching Assistant, \textit{University of Hawaii at Manoa}} & \textbf{2007 --- 2009}\\
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
...
\noindent\begin{tabularx}{\linewidth}{@{}lR@{}}	
	...
	\textbf{PhD, Experimental Particle Physics} & \textbf{2016}\\
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
...
%------------------------------------------------
	...
	\textbf{Double BS, Physics and Mathematics} & \textbf{2005}\\
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
...
\clearpage
\section{\textcolor{NavyBlue}{Talks and Presentations}}
...
\clearpage
\renewcommand\refname{\textcolor{NavyBlue}{Publications}} %changes default name to Publications
...
\clearpage
\section{\textcolor{NavyBlue}{Statement of Research}}

...
\begin{center}
	...
	\noindent\begin{tabular}{r @{$\quad\bullet\quad$} c @{$\quad\bullet\quad$} l}
		\href{mailto:michsakai@berkeley.edu}{michsakai@berkeley.edu} & 808.206.4357 & \href{https://www.linkedin.com/in/michinari-sakai-956b3b156/}{www.linkedin.com/in/michinari-sakai}
	\end{tabular}
\end{center}
...
\noindent\begin{tabularx}{\linewidth}{@{{}\textbullet\enskip}X@{\quad}r@{}}
	%Experience with cosmogenic radiation and nuclear decay radiation in 3
	%major particle physics experiments. & \\
	Experience with algorithm development and large-scale data analysis in 3
	international physics experiments. & \\
	%Expertise in \textsc{Geant4} particle transport simulations with 8 years
	%of experience. & \\
	Expertise in \textsc{Geant4} physics simulations with 8 years of
	experience. & \\
...
\noindent\begin{tabularx}{\linewidth}{@{}lR@{}}
	...
	\textcolor{NavyBlue}{\textsc{UC Berkeley --- }Post-doctoral Scholar} & \textcolor{NavyBlue}{\textsc{June 2018 ---} \textit{Current}}\\
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		...
		\begin{itemize}
			\item Supervisor for simulation and modeling of photon
	...
	%\textbf{CUORE (Cryogenic Underground Observatory for Rare Events)} & \textsc{Mar. 15, 2016 -} \textit{Current}\\
	\textcolor{NavyBlue}{\textsc{UCLA --- }Post-doctoral Scholar} & \textcolor{NavyBlue}{\textsc{2016 ---} \textsc{2018}}\\
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		%\textit{Post-doctoral Scholar, University of California, Los Angeles (UCLA)}
		%\textit{University of California, Los Angeles (UCLA)}
		\begin{itemize}
			\item Mentor for 2 PhD students to model and simulate radiation
				shielding structures to mitigate $\gamma$/$\beta$
				backgrounds for ultra-low radiation environments.
			\item Lead developer of precision $\alpha$ decay spectrum model to
				improve characterization of backgrounds in ultra-low radiation
				environments.
	...
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		...
		\begin{itemize}
			\item Spearheaded algorithm development of a novel directional
				neutrino detection technology in scintillator and demonstrated
				with data for the first time that this can be applied to
				conduct indirect dark matter searches in scintillator. First
				ever physics application of neutrino directionaly in
				scintillator. Paper in preparation.
...
\noindent\begin{tabularx}{\linewidth}{@{}rl}
	...
	Software/Tools: & \textsc{ROOT} (statistical analysis), \textsc{Geant4} (physics simulation), \textsc{SolidWorks}, \textsc{AutoCAD}, \textsc{Pads}\\
...
\noindent\begin{tabularx}{\linewidth}{@{}lR@{}}
	...
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
			\item Advised 2 students with optical physics modeling for current
				hardware project. Students are now undertaking independent
				research tasks and contributing original work.
			\item Taught weekly physics simulation tutorials to \num{3}
				PhD-level students for a semester. Students successfully
				learned to take on independent simulation projects.
...
I have a strong background in physics simulations and how they affect real
detector hardware. My expertise also involves processing and analyzing
large-scale physics data using analysis tools such as ROOT and Python. I have
experience working in 3 multinational collaboration physics experiments where I
spearheaded independent research initiatives and successfully interfaced my
original work with the larger team. Some of my past accomplishments that I take
pride in include development of unprecedented particle detection algorithms
that I project will open whole new endeavors by the collaborations that I have
worked with.
...
I led the development of the \textsc{Geant4} physics simulation code for the
...
In summary my strong background in physics simulations and how they affect real
hardware, as well as, my comfort in using tools to analyze large-scale physics
data makes me a strong candidate. Also I would like to reemphasize my previous
accomplishments in innovating novel particle detection algorithms to solve
complex problems and interface my original work with a large group of
...
& 2505 Correa Rd. Watanabe \#327, Honolulu, Hawaii 96822, USA\\
\\
...
\\
Frederick A. \textsc{Harris} & Professor, University of Hawaii at Manoa, +1-808-956-7087\\
& \href{mailto:fah@phys.hawaii.edu}{\nolinkurl{fah@phys.hawaii.edu}}\\
& 2505 Correa Rd. Watanabe \#416, Honolulu, Hawaii 96822, USA\\

...
\recipient{Applied Physics Laboratory}
...
As a budding and motivated physicist, I am extremely interested in joining your
team to lead and contribute to radiation efforts on Civil Space and National
Security Space missions. 
I would like to apply for the position.

I am currently a post-doctoral researcher at the University of California,
Berkeley
with expertise in particle transport simulations working in the field of
...
\noindent\begin{tabularx}{\linewidth}{@{{}\textbullet\enskip}X@{\quad}@{}}
	...
	on particle transport simulations and algorithm development for novel
	...
	nuclear physics working with radiation effects and modeling in a cryogenic
	(\SI{\sim10}{mK}) vacuum environment similar to that in deep space.\\
	\textbf{Effective written and oral communication skills:}
	Contributed work published in various journals, and oral presentations
	given at institutions such as Lawrence Livermore National Laboratory,
	Fermilab, Argonne National Laboratory, Los Alamos National Laboratory.\\
	\textbf{Ability to work with a variety of people across engineering and
	science disciplines:} Worked in 3 multinational collaborations comprised
	of physicists and engineers in Japan, Italy, US. Mentored PhD-level
	students and increased team productivity by organizing group initiatives.\\
	\textbf{Experience with radiation transport codes:} 8 years of experience
	working with Geant4.\\
	\textbf{Experience with radiation transport problems in structures:} Past
	simulation work involves nuclear decay radiation through various materials
	such as steel, lead, copper, Teflon with the CUORE double beta decay
	experiment. Other work involved modeling cosmogenic muons and studying
	their radiation effects in simulations with the KamLAND neutrino detector
	experiment.\\
	%Was responsible for

...
\titleformat{\section}{\Large}{}{0em}{}[\titlerule] % Text formatting of sections
\titlespacing{\section}{0pt}{-5pt}{-5pt} % Spacing around sections
...
\begin{center}
	...
	\noindent\begin{tabular}{r @{$\quad\textbullet\quad$} c @{$\quad\textbullet\quad$} l}
		%\href{mailto:michsakai@gmail.com}{michsakai@gmail.com} & 808.206.4357 & \href{https://www.linkedin.com/in/michinari-sakai-956b3b156/}{www.linkedin.com/in/michinari-sakai-956b3b156/}
...
\noindent\begin{tabularx}{\linewidth}{@{{}\textbullet\enskip}X@{\quad}r@{}}
	Extensive experience with large-scale data analysis, photon/radiation
	simulations, and algorithm development. & \\
	Lead developer of Geant4 simulation of detector employing multi-channel
	plate photo-sensors. & \\
...
\noindent\begin{tabularx}{\linewidth}{@{}lR@{}}
	...
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
			...
			%	optical properties of wavelength shifter thinfilms.
			\item Supervisor for simulation/modeling of photon interactions
				with optical wavelength shifters.
			\item Data analysis lead for energy spectrum of alpha decay
				radiation from radioactive contaminations.
		\end{itemize} 
	\end{minipage}}\\
	...
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		...
		\begin{itemize}
			\item Mentor for 2 PhD students to simulate radiation shielding
				structures to mitigate gamma/beta backgrounds for next
				generation neutrinoless double beta decay searches requiring
				ultra-low radiation environments.
			\item Lead developer of precision alpha decay spectrum model to
				improve characterization of backgrounds in neutrinoless double
				beta decay decay searches.
	...
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		...
		\begin{itemize}
			\item Lead developer of remote particle detector simulation code
				employing multi-channel plate photo-sensors and scintillator.
				Simulation results were later used to oversee detector design
				and construction.
			\item Spearheaded development of a novel remote directional neutrino
...
\noindent\begin{tabularx}{\linewidth}{@{}rl}
	Software/Tools: & ROOT, Geant4, LabView, SolidWorks, AutoCAD, ComSol, Git,
	Pads\\
	Programming Languages: & Proficient in Python, C/C++, Mathematica, BASH,
	Fortan; experience with Matlab, R, Perl\\
	Human Languages: & English (native), Japanese/Korean (trilingual
	proficiency)\\
\end{tabularx}
...
\noindent\begin{tabularx}{\linewidth}{@{}lR@{}}
	...
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
			\item Advised 2 students with optical simulation code for current
				hardware project. Students are now undertaking independent
				research tasks and contributing original work.
			\item Taught weekly Geant4 physics simulation tutorials to
				\num{3} PhD-level students for a semester. Students
				successfully learned to take on independent projects.
...
%------------------------------------------------
	...
	% BS, Physics and Mathematics & March 2, 2001 - August 19, 2005
...
I have a strong background in optical photon and radiation transport simulations
and how they affect real radiation sensor hardware. My expertise also involves
...
tube (PMT) photo-sensors deployed in the detector. The studies were used to develop
...
In summary, my strong background in optical photon and radiation transport
simulations and how they affect real radiation sensors, as well as, my comfort
in using tools to analyze large-scale physics data makes me a strong candidate.
Also I would like to reemphasize my previous accomplishments in innovating
novel particle detection techniques to solve complex problems and interface my

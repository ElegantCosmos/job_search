...
\noindent\begin{tabularx}{\linewidth}{@{{}\textbullet\enskip}X@{\quad}r@{}}
	Experience with highly segmented calorimeter detectors and
	reconstruction of energy spectrum of backgrounds. & \\
	Extensive experience in analyzing large-scale data sets, Geant4
...
\noindent\begin{tabularx}{\linewidth}{@{}lR@{}}
	...
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
			...
			\item Data analysis lead for energy spectrum of radioactive isotope
				alpha decays.%
			\item Mentor for modeling of photon interactions with optical
				wavelength shifters with Geant4.%
		\end{itemize}
	\end{minipage}}\\
	...
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		...
		\begin{itemize}
			\item Lead developer of precision energy spectrum model for
				radioactive alpha decays to improve characterization of
				backgrounds in neutrinoless double beta decay decay searches.%
			\item Mentor for 2 PhD students to simulate radiation shielding
				structures in Geant4 to mitigate gamma/beta backgrounds for
				next generation neutrinoless double beta decay searches
				requiring ultra-low radiation environments.%
	...
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		...
		\begin{itemize}
			...
			\item Lead developer of neutrino detector simulation code using
				Geant4 to conducted case studies of neutron capture doping
				agents in solid scintillator. Simulation results were later
				used to oversee detector design and construction.%

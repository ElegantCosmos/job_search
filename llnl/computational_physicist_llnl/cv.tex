...
\sisetup{range-phrase=\ensuremath{-}}
...
\noindent\begin{tabularx}{\linewidth}{@{}lR@{}}
	\textsc{Mini-TimeCube (World's Smallest Portable Neutrino Detector)} -
	\textit{University of Hawaii} & \textsc{2009 - 2016}\\
	...
	\end{minipage}}\\
	\addlinespace[5pt]
	\textsc{KamLAND (Kamioka Liquid Scintillator Antineutrino Detector)} -
	\textit{University of Hawaii} & \textsc{2009 - 2016}\\
	...
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
			...
			\item Led unprecedented particle ID capability studies in
				...
				and never before observed T2K events spilling into KamLAND
	...
	\end{minipage}}\\
	\addlinespace[5pt]
	\textsc{Hanohano (Deep Sea-based monolithic Scintillator Neutrino
	Detector)} - \textit{University of Hawaii} & \textsc{2009 -
	2010}\\
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
			\item Used CAD to design and assemble apparatus to measure light
				output of various LAB based scintillators from ionizing
				radiation as well as test light yield changes in extreme
				electric potential gradients ($\SI{\sim
				1}{\kilo\volt\per\centi\meter}$)
			%\item Led critical role in directional neutrino/neutron
			%	reconstruction algorithm
			\item Operated, took data, and analyzed light transmissivity of LAB
				based scintillator when put in near freezing temperatures and
				high pressure environments (for potential deep sea deployment
				scenarios) in custom made pressurizer chamber
			%\item Spearheaded trade studies for \ce{Li}/\ce{B} neutron capture
			%	dopants in scintillator
		\end{itemize}
	\end{minipage}}\\
	...
	%\textsc{CUORE (Cryogenic Underground Observatory for Rare Events)} - \textit{UCLA} & \textsc{Apr. 2016 -} \textit{Current}\\
	\textsc{CUORE (Cryogenic Underground Observatory for Rare Events)} - \textit{UCLA} & \textsc{2016 -} \textit{Current}\\
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
...
\noindent\begin{tabularx}{\linewidth}{@{}lR@{}}
	%\textsc{Mentor}, \textit{UCLA} & \textsc{Apr 2016 -} \textit{Current}\\
	...
	\textsc{Teaching Assistant} - \textit{University of Hawaii} & \textsc{2007 - 2009}\\
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
...
%\noindent\begin{tabular}{rp{10.3cm}}	
	...
	%\textsc{PhD, Experimental Neutrino Physics} & \textsc{May 2016}\\
	\textsc{PhD, Experimental Particle Physics} & \textsc{May 2016}\\
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
...
%------------------------------------------------
	...
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
			\item[] President's Award 2005, Award for Outstanding Academic
				Achievement -- Samsung Corp.
...
($0\nu\beta\beta$) decay in \ce{^{130}Te}. CUORE employs an almost 20 fold

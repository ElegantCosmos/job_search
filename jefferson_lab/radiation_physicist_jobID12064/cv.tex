...
\noindent\begin{tabularx}{\linewidth}{@{{}\textbullet\enskip}X@{\quad}r@{}}
	Extensive experience in particle physics simulation code and
	analyzing large amounts of real/simulated data.& \\
	Proficient in large-scale data analysis and algorithm software development
...
\noindent\begin{tabularx}{\linewidth}{@{}lR@{}}
	...
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		\begin{itemize}
			...
			\item Data analysis lead for energy spectrum of radioactive isotope
				alpha decays.
	...
	\multicolumn{2}{@{}l@{}}{\begin{minipage}[t]{\linewidth}
		...
		\begin{itemize}
			\item Lead developer of detector simulation code
				to conducted case studies of neutron capture doping agents in
...
\clearpage
\section{Statement of Research Experience}

I have a strong background in radiation/particle transport simulations and how
they affect particle detector hardware. My expertise also involves
...
how they affect particle detectors, as well as, my comfort in using tools
...
%
%Jason Kumar & Assoc. Professor, Univ. of Hawaii at Manoa, +1-808-956-2972,
%\href{mailto:jkumar@phys.hawaii.edu}{\nolinkurl{jkumar@phys.hawaii.edu}}\\
%
%Jelena Maricic & Assoc. Professor, Univ. of Hawaii at Manoa, +1-808-956-7176,
